...
import {PrimeNGConfig} from './config/calendar.config';
import {LocaleSettings} from './calendar.interface';
import {UniqueComponentId} from 'primeng/utils';
import {PrimeTemplate} from 'primeng/api';
import {OverlayService} from './config/overlayservice';
import {TranslationKeys} from './config/translationkeys';
...
export class Calendar implements OnInit, OnDestroy, ControlValueAccessor {
  ...
  isValidDate(date) {
    return date instanceof Date /*&& ObjectUtils.isnot(date)*/; //fix later
  }
